...
//!
//! The pure-render helpers (head, body, escape) live in `crabcloud-ui` so
//! the UI crate has no dependency on `crabcloud-http`. This module wires
...
use crabcloud_ui::{render_app_html, render_head_html, RequestContext, HTML_DOCTYPE};
